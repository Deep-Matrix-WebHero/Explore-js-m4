...
// তো মার কাজ হচ্ ছে সংখ্ যা গুলা একটার পর একটা করে চেক করা।
// এবং সংখ্ যা গুলা যদি পজিটিভ সংখ্ যা হয়। অর্ থাৎ শূন্ য এর চাইতে বড়
// হয় তাহলে সেগুলাকে কো ন একটা array এর মধ্ যে রাখবে।
// আর যদি নেগেটিভ সংখ্ যা হয়। তাহলে লুপটা স্ টপ করে দিবে।
// এবং লুপ বন্ ধ করার আগ পর্ যন্ ত যতগুলা পজিটিভ সংখ্ যা পাওয়া গেছে।
// সেগুলা রিটার্ ন করে দিবে।
...
function deliveryCost(tshartNumber) {
    if (deliveryCost > 0) {
        let getMoneyfristOption = 100;
        let getMoneysecondOption = 80;
        let getMoneyLastOption = 50;

        if (tshartNumber <= 100) {
            const earnmoney = tshartNumber * getMoneyfristOption;
            return earnmoney;
        } else if (tshartNumber > 100 && tshartNumber <= 200) {
            const earnMoney1st100tshart = 100 * getMoneyfristOption;
            const restEarn = tshartNumber - 100;
            const earnMoney2nd100tshart = restEarn * getMoneysecondOption;
            const totalEarn = earnMoney1st100tshart + earnMoney2nd100tshart;
            return totalEarn;

        } else {
            const earnMoney1st100tshart = 100 * getMoneyfristOption;
            const earnMoney2nd100tshart = 100 * getMoneysecondOption;
            const restEarn3rd = tshartNumber - 200;
            const restEarn3rdoption = restEarn3rd * getMoneyLastOption
            const totalEarn3rdOption = earnMoney1st100tshart + earnMoney2nd100tshart + restEarn3rdoption;
            return totalEarn3rdOption;
        } else {
            return "error";
        }

    }
    let totalSellingCost = deliveryCost(1);
    console.log(totalSellingCost);
    // if (totalSellingCost <= 0) {
    //     console.log('error')
    // }
    ...
    function totalSales(shirtQuantity, pantQuantity, shoeQuantity) {
        ...
        // Any valid input entered
        else {
            //calculation

            //total individual sales
            var totalShirtSales = shirtPrice * shirtQuantity;
            var totalPantSales = pantPrice * pantQuantity;
            var totalShoeSales = shoePrice * shoeQuantity;

            //total Sales
            var totalSales = totalShirtSales + totalPantSales + totalShoeSales;
            return totalSales;
        }
...
//function call
var totalPrice = totalSales(1, 1, 1);
//output
